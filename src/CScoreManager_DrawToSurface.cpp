...
void __thiscall CScoreManager::DrawToSurface(CScoreManager *this)
{
  ...
  _BYTE v34[8]; // [esp+10h] [ebp-24h] BYREF
  ...
  {
    v6 -= 9;
    v36 = (unsigned int)v38 % 0xA;
    v38 = (struct IDirectDrawSurface7 *)((unsigned int)v38 / 0xA);
  ...
  v17 = v13 - 20;
  v38 = (struct IDirectDrawSurface7 *)*((_DWORD *)v37 + 10);
