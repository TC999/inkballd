//----- (01003E31) --------------------------------------------------------
void CBall::InitBallPoints(CBall* self)
{
  int v2; // eax
  int v3; // edx
  int v4; // edi
  ...
  v4 = 1;
  v5 = (int *)(*(_DWORD *)v2 + 8);
  v7 = (double)*(int *)(*(_DWORD *)v2 + 4) * *((double *)self + 9) + (double)**(int **)v2 * *((double *)self + 8);
  do
  {
    v8 = (double)v5[1] * *((double *)self + 9) + (double)*v5 * *((double *)self + 8);
    if ( v8 > (double)v7 )
    {
      v3 = v4;
      v7 = v8;
