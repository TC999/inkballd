...
int CInk_GetInkUpdateRect(CInk *self, struct tagRECT *a2)
{
  int v3; // edi
  bool v4; // zf
  ...
  v3 = 0;
  v8[0] = 0;
  Helpers::CLogBlock::CLogBlock(reinterpret_cast<Helpers::CLogBlock*>(v7), "CInk::GetInkUpdateRect", v8);
