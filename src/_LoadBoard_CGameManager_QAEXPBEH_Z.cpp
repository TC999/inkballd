...
void CGameManager::LoadBoard(CGameManager *this, const unsigned __int8 *a2, int a3)
{
  ...
  CBoardTile*v35; // eax
  CBoardTile*v36; // ecx
  uint8_t v37[8]; // [esp+10h] [ebp-28h] BYREF
  CBoardTile*v38; // [esp+18h] [ebp-20h]
  ...
  CGameBoard::AddGameObjectToUpdateList(g_pCGameBoard, *((CGameObject**)g_pCGameBoard + 2479));
  v9 = 1000 * *v7;
  v10 = v7 + 1;
  if ( v9 > 0xEA60 )
    goto LABEL_8;
  ...
  v13 = *v12 + v11;
  v14 = v12 + 1;
  if ( (uint32_t)(v13 - 50) > 0xFA )
    goto LABEL_8;
  v15 = *v14 << 8;
  v16 = v14 + 1;
  v17 = *v16 + v15;
  v18 = v16 + 1;
  if ( (uint32_t)(v17 - 50) > 0xFA )
    goto LABEL_8;
  if ( v13 > v17 )
    goto LABEL_8;
  v19 = (CBoardTile*)*v18;
  ...
  do
  {
    if ( v42 >= *((uint32_t *)g_pCGameBoard + 2470) )
      break;
    v41 = 0;
    v25 = v22 + 4;
    v26 = v22 + 2;
    while ( v41 < *((uint32_t *)g_pCGameBoard + 2469) )
    {
      v27 = *v22;
      v44 = -2147024882;
      if ( (*v22 & 0xF0) == 0x40 )
