...
int CSurface::Create(void* _self, struct IDirectDrawSurface7** pSurface, struct IDirectDraw7 *a2, struct DDSURFACEDESC2 *a3)
{
    CSurface* self = (CSurface*)_self;
    ...
    *(uint32_t *)v10 = 0;
    ...
    v11 = 0;
    *(uint32_t *)v10 = a2->lpVtbl->CreateSurface(a2, (struct _DDSURFACEDESC2*)a3, pSurface, 0);
    if ( *(int*)v10 < 0 )
    {
    ...
    {
        auto v5 = (struct DDSURFACEDESC2 *)((uint8_t*)self + 4);
        v6 = *pSurface;
        v5->dwSize = 124;
