...
int __thiscall CDisplay::ConvertGDIColor(CDisplay *this, COLORREF color)
{
  ...
  if ( !v4 )
  {
    ...
    if ( color != -1 )
    {
      v6 = (*(int (__stdcall **)(_DWORD, HDC *))(**((_DWORD **)this + 5) + 68))(*((_DWORD *)this + 5), hdc);
      if ( v6 )
      {
        if ( WPP_GLOBAL_Control != &WPP_GLOBAL_Control && (*((_BYTE *)WPP_GLOBAL_Control + 28) & 4) != 0 )
          WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x22u, &stru_1002FB8, v6);
      }
      else
      {
        Pixel = GetPixel(hdc[0], 0, 0);
        SetPixel(hdc[0], 0, 0, color);
        (*(void (__stdcall **)(_DWORD, HDC))(**((_DWORD **)this + 5) + 104))(*((_DWORD *)this + 5), hdc[0]);
      }
    }
    v7 = *((_DWORD *)this + 5);
    v9[0] = 124;
    if ( !(*(int (__stdcall **)(int, _DWORD, _DWORD *, int, _DWORD))(*(_DWORD *)v7 + 100))(v7, 0, v9, 1, 0) )
    {
      ...
      if ( v10 < 0x20 )
        v13 &= (1 << v10) - 1;
      (*(void (__stdcall **)(_DWORD, _DWORD))(**((_DWORD **)this + 5) + 128))(*((_DWORD *)this + 5), 0);
    }
    if ( color != -1 )
    {
      v8 = (*(int (__stdcall **)(_DWORD, HDC *))(**((_DWORD **)this + 5) + 68))(*((_DWORD *)this + 5), hdc);
      if ( v8 )
      {
        if ( WPP_GLOBAL_Control != &WPP_GLOBAL_Control && (*((_BYTE *)WPP_GLOBAL_Control + 28) & 4) != 0 )
          WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x23u, &stru_1002FB8, v8);
      }
      else
      {
